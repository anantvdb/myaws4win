...
aws_vmtypes  = [#('t2', [ ('.micro',   '(   1 vcpu, 1Gb vram )\t'),
                ...
                ('m6i',[ ('.4xlarge', '(  16 vcpu, 64Gb vram )\t'), 
                         ('.12xlarge','(  48 vcpu, 192Gb vram )\t'), 
                         ('.24xlarge','(  96 vcpu, 384Gb vram )\t'), 
                         ('.32xlarge','( 128 vcpu, 512Gb vram )\t') ]),
                #         ('.metal',   '( 128 vcpu, 512Gb vram )\t') ]), 
                #('m6id',[('.4xlarge', '(  16 vcpu, 64Gb vram )\t'), 
                #         ('.12xlarge','(  48 vcpu, 192Gb vram )\t'), 
                #         ('.24xlarge','(  96 vcpu, 384Gb vram )\t'), 
                #         ('.32xlarge','( 128 vcpu, 512Gb vram )\t'),
                #         ('.metal',   '( 128 vcpu, 512Gb vram )\t') ]), 
                ('m7i',[ ('.4xlarge', '(  16 vcpu, 64Gb vram )\t'), 
                         ('.12xlarge','(  48 vcpu, 192Gb vram )\t'), 
                         ('.24xlarge','(  96 vcpu, 384Gb vram )\t'), 
                         ('.48xlarge','( 192 vcpu, 768Gb vram )\t') ]),
                #('m7id',[('.4xlarge', '(  16 vcpu, 64Gb vram )\t'), 
                #         ('.12xlarge','(  48 vcpu, 192Gb vram )\t'), 
                #         ('.24xlarge','(  96 vcpu, 384Gb vram )\t'), 
                #         ('.32xlarge','( 128 vcpu, 512Gb vram )\t'),
                #         ('.metal',   '( 128 vcpu, 512Gb vram )\t') ]), 
...
aws_default_vmtype_update  = 'm7i.12xlarge'
aws_default_vmtype_rebuild = 'm7i.48xlarge'
